...
public:
  ...
  //@{
  /**
   * Set/get whether the color modulation apply for lookup table 

   * When ColorModulation swith is ON then it will be applyed
   */
  vtkSetMacro( ColorModulation, int );
  vtkGetMacro( ColorModulation, int );
  vtkBooleanMacro(ColorModulation,int);
  //@}
