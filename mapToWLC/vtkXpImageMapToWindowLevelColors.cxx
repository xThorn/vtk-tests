/*=========================================================================
  ...
  Module:    vtkXpImageMapToWindowLevelColors.cxx
...
vtkStandardNewMacro(vtkXpImageMapToWindowLevelColors);

// Constructor sets default values
vtkXpImageMapToWindowLevelColors::vtkXpImageMapToWindowLevelColors()
{
  this->Window = 255;
  this->Level  = 127.5;
}

vtkXpImageMapToWindowLevelColors::~vtkXpImageMapToWindowLevelColors() = default;

//----------------------------------------------------------------------------
// This method checks to see if we can simply reference the input data
int vtkXpImageMapToWindowLevelColors::RequestData(
...
//----------------------------------------------------------------------------
int vtkXpImageMapToWindowLevelColors::RequestInformation (
...
template <class T>
void vtkXpImageMapToWindowLevelColorsExecute(
  vtkXpImageMapToWindowLevelColors *self,
...
void vtkXpImageMapToWindowLevelColors::ThreadedRequestData(
  vtkInformation *vtkNotUsed(request),
  ...
  int outExt[6], int id)
{
  ...
  {
    vtkTemplateMacro(
      vtkXpImageMapToWindowLevelColorsExecute(this,
                                            inData[0][0],
...
void vtkXpImageMapToWindowLevelColors::PrintSelf(ostream& os, vtkIndent indent)
{
